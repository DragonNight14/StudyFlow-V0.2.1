...
class AssignmentEditor {
    ...
    editAssignment(assignmentId) {
        console.log('AssignmentEditor.editAssignment called with ID:', assignmentId);
        
        this.currentAssignment = this.tracker.assignments.find(a => a.id === assignmentId);
        if (!this.currentAssignment) {
            console.error('Assignment not found:', assignmentId);
            this.tracker.showNotification('Assignment not found', 'error');
            return;
        }

        console.log('Found assignment:', this.currentAssignment.title);

        // Only allow editing of manual assignments
        if (this.currentAssignment.source && this.currentAssignment.source !== 'manual') {
            console.log('Cannot edit non-manual assignment');
    ...
    showEditModal() {
        ...
        // Escape any quotes in the assignment data
        const safeTitle = (this.currentAssignment.title || '').replace(/"/g, '&quot;');
        const safeDescription = (this.currentAssignment.description || '').replace(/"/g, '&quot;');
        const safeCourseName = (this.currentAssignment.courseName || '').replace(/"/g, '&quot;');
                ...
                <form class="edit-form" id="edit-form">
                    <div class="form-section">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" id="edit-title" value="${safeTitle}" required>
                        </div>

                        <div class="form-group">
                            <label for="edit-description">Description</label>
                            <textarea id="edit-description" rows="3">${safeDescription}</textarea>
                        </div>
                        ...
                        <div class="form-row">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" id="edit-course" value="${safeCourseName}">
                            </div>
                        </div>
                    </div>
        ...
        try {
            ...
            this.tracker.showNotification('Failed to create edit modal: ' + error.message, 'error');
        }
    }
